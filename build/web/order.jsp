...
<center>
             ...
             <%
             ps=con.prepareStatement("select name from products where id in (select item from buy where userid=?)");
             ps.setString(1, s);
             ...
             %>
                     ...
                     <tr>
                         ...
                         <td> 
                         <%
                         PreparedStatement ps2=con.prepareStatement("select count(item) from buy where userid=? AND item in(select id from products where name = ?) ");
                         ps2.setString(1, s);
